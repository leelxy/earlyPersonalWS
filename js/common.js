...
function getByClass(oParent,sClass){
	if(oParent.getElementsByClassName){ //兼容IE9+
...
function hoverDir(obj,oEvent){
	...
	var x = obj.offsetWidth/2 + getPos(obj).left -oEvent.clientX;
	var y = obj.offsetHeight/2 + getPos(obj).top - scrollT - oEvent.clientY;
	return Math.round((Math.atan2(y,x)/Math.PI*180+180)/90)%4;
}
